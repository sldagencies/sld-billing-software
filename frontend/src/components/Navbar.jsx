    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginRight: 20, padding: "10px 0" }}>
        <div style={{ background: "#1A4480", borderRadius: 8, width: 36, height: 36,
          ...
          color: "#E8A020", fontSize: 16, fontWeight: 900, letterSpacing: 0.5 }}>SLD</div>
        <div>
          <div style={{ fontWeight: 800, fontSize: 14, color: "#0B1F3A" }}>SLD Billing</div>
          <div style={{ fontSize: 10, color: "#64748b" }}>Sree Laxmidurga Agencies</div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 0" }}>
        <div style={{ fontSize: 13, color: "#475569" }}>
          ...
          <span style={{ marginLeft: 6, background: role === "owner" ? "#1A4480" : "#059669",
            color: "#fff", borderRadius: 50, padding: "2px 8px", fontSize: 11, fontWeight: 600 }}>
            {role}
          </span>
        </div>
        <button onClick={onLogout} style={{ background: "#fee2e2", color: "#dc2626",
          border: "none", borderRadius: 6, padding: "7px 14px", fontSize: 13,
